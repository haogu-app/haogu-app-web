  ...
  return (
    <div className="space-y-6 pb-32">
      ...
      <div className="px-6">
        <button
          onClick={handleShare}
          className="w-full bg-accent-50 border border-accent-100 p-4 rounded-2xl flex items-center justify-center gap-3 hover:bg-accent-100 transition-colors group shadow-sm"
        >
